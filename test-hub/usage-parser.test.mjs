...
test('usage parser reads OpenAI JSON and Anthropic-style SSE usage', () => {
  ...
  assert.deepEqual(jsonParser.finish(), { inputTokens: 12, outputTokens: 5, cachedTokens: 3, reasoningTokens: 0, errorType: '' });
  ...
  assert.deepEqual(streamParser.finish(), { inputTokens: 7, outputTokens: 9, cachedTokens: 0, reasoningTokens: 0, errorType: '' });
});
